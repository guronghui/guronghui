    ...
    success: function (result) {
      if (result.uname) {
        $(".login_info").html(
          "<li>&nbsp;欢迎:" +
            result.uname +
            ' <a href="logout.html" title="退出登录">退出</a><b>|</b></li><li><a href="uc_basic.html" title="用户中心">用户中心</a></li>'
        );
...
function alertMsg(msg, mode) {
  ...
  //遮罩层
  var styleStr =
    "top:0;left:0;position:absolute;z-index:10000;background:rgba(0,0,0,.6);width:" +
    winSize.pageWidth +
    "px;height:" +
  ...
  //弹出框
  var styleStr1 =
    "display:block;position:fixed;_position:absolute;left:" +
    (winSize.windowWidth / 2 - 200) +
    "px;top:" +
    (winSize.windowHeight / 2 - 150) +
    "px;_top:" +
    (winSize.windowHeight / 2 + top - 150) +
    "px;"; //弹出框的位置
