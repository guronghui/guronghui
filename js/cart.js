            ...
            <div class="imfor">
              ...
              <div class="pudc">
                <div class="pudc_information" id="${l.iid}">
                  <a href="product_details.html?lid=${l.lid}"><img src="${
            l.pic
          }" class="lf"/></a>
                  <input type="hidden" name="" value="">
                          <span class="des lf">
                              <a href="03_product_details.html?lid=${l.lid}">${
            l.title
          }</a>
                                <input type="hidden" name="" value="">
                          </span>
                  <p class="col lf"><span>规格：</span><span class="color_des">${
                    l.spec
              ...
              <div class="pices">
                ...
                <p class="pices_information"><b>￥</b><span>${
                  l.price
                }  <input type="hidden" name="" value=""></span></p>
              </div>
              <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${
                l.count
              }"><span class="add">&nbsp;+&nbsp;</span>
              </div>
              <div class="totle">
...
$(function () {
  ...
  $(".imfor").each(function () {
    ...
    $(this)
      .children(".totle")
      .children(".totle_information")
      .html(amountPrice.toFixed(2));
  });
  //全选
  $(".all").click(function () {
    amountadd();
...
function adddel() {
  ...
  $("#content_box_body").on("click", ".add", function () {
    ...
    $(this).prev().val(vall);
    $multi =
      parseInt(vall).toFixed(2) *
      parseInt(
        $(this).parent().prev().children().eq(1).children().eq(1).text()
      );
    $(this)
      .parent()
      .next()
      .children()
      .eq(1)
      .text(Math.round($multi).toFixed(2));
    amountadd();
    var id = $(this)
      .parent()
      .siblings(".pudc")
  ...
  $("#content_box_body").on("click", ".reduc", function () {
    ...
    $(this)
      ...
      .children()
      .eq(1)
      .text(Math.round($multi1).toFixed(2));
    amountadd();
    var id = $(this)
      .parent()
      .siblings(".pudc")
