...
****************************************************************/
    ...
    function gologin(e) {
      ...
      //		   将保存的用户信息放入输入框
      if (luname && lupwd) {
        $("div.zhuazi-login ul.login-box li.my_memory #my_memory").attr(
          "checked",
          "checked"
        );
    ...
    var $login_save = $(
      "div.zhuazi-login ul.login-box li.my_memory #my_memory"
    );
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.code == 200) {
            ...
            $("#hiden_bg").css("opacity", 0.5);
            $("#hiden_bg").html(
              "登录失败，用户名或者密码错误，点击<br><a href='javascript:' class='repeat_login'>重新登录<a>"
            );
            $("#hiden_bg a.repeat_login").click(function (e) {
              gologin(e);
            });
          }
        },
        error: function () {
          ...
          $("#hiden_bg").css("opacity", 0.5);
          $("#hiden_bg").html(
            "登录失败，可能是网络问题，请仔细检查网络，点击<br><a href='javascript:' class='repeat_login'>重新登录<a>"
          );
          $("#hiden_bg a.repeat_login").click(function (e) {
            gologin(e);
          });
    ...
    function login_block(data) {
      ...
      $login_li.html(`
		  欢迎 <span>${data.name.slice(0, 1)}**${
        data.gender == "1" ? "先生" : "女士"
      }</span><a href='javascript:;' class='my_login'></a>  
	   `);
      //  登录之后的头像弹框操作 点击弹出与消失
...
*******************************************************************************/
    ...
    $("#header_search_box>input").keyup(function () {
      ...
      $.ajax({
        ...
        success: function (pager) {
          ...
          html != ""
            ? (html += `<p><a  href="javascript:;" class="close_help">关闭</a></p>`)
            : "none";
          // console.log(html);
    ...
    function getCode() {
      ...
      //		   点击时换验证码
      $("div.zhuazi-login ul.login-box li a.code>span").click(function () {
        getCode();
      });
      function rn(min, max) {
